                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-success">ຂໍ້ມູນທັງໝົດ 
                                <button class="btn btn-success" data-toggle="modal" data-target="#contentModal"><i class="fas fa-plus-circle"></i></button>
                                &nbsp;
                                <button class="btn btn-success" data-toggle="modal" data-target="#contenteditedModal"><i class="fas fa-edit"></i></button>
                                &nbsp;
                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#contendeletedtModal" ><i class="fas fa-trash-restore"></i></button>
                            </h6>
                        </div>
                        <div class="card-body">
