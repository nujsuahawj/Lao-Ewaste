...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a href="Home.php" class="navbar-brand">Ecogrowth<span class="text-success">Lao</span></a>
        ...
        <div class="navbar-collapse collapse" id="navbarContent">
          <ul class="navbar-nav ml-auto pt-3 pt-lg-0">
            <li class="nav-item active">
              <a href="Home.php" class="nav-link text-success">ໜ້າລັກ</a>
            </li>
            <li class="nav-item">
              <a href="About.php" class="nav-link">ກ່ຽວກັບ</a>
            </li>
            <li class="nav-item">
              <a href="Conten.php" class="nav-link">ຂ່າວສານ</a>
            </li>
            <li class="nav-item">
              <a href="Registation.php" class="nav-link">ລົງທະບຽນ</a>
            </li>
            <li class="nav-item">
              <a href="Score.php" class="nav-link">ເບິ່ງຄະແນນ</a>
            </li>
          </ul>
        </div>
    </div> <!-- .container -->
